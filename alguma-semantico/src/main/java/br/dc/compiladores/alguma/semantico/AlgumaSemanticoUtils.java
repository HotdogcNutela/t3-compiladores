...
public class AlgumaSemanticoUtils {
    ...
    public static TabelaDeSimbolos.TipoAlguma verificarTipo(TabelaDeSimbolos tabela, AlgumaSemanticoParser.ExpressaoAritmeticaContext ctx) {
    ...
    public static TabelaDeSimbolos.TipoAlguma verificarTipo(TabelaDeSimbolos tabela, AlgumaSemanticoParser.TermoAritmeticoContext ctx) {
        TabelaDeSimbolos.TipoAlguma ret = null;
    ...
    public static TabelaDeSimbolos.TipoAlguma verificarTipo(TabelaDeSimbolos tabela, AlgumaSemanticoParser.FatorAritmeticoContext ctx) {
        if (ctx.NUMINT() != null) {
